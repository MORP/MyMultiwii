...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /***************************    independent sensors    ********************************/
      ...
      /* I2C LIDAR Lite range sensor */
      
      //#define i2cLidar  //this is mean't for taking the code by guru_florida once it works
	 ...
	 VEL(P, I) are used to PID tuning.
 ...
 */
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_THROTTLE  (MINTHROTTLE + 70)    // (*) Throttle level used for landing - may be relative to MINTHROTTLE - as in this case
...
#define MAG_DECLINATION  3.44 //3.1667f   //(**)
...
#define LAND_SPEED          100
  ...
  /********************************************************************/
    ...
    #define VBATSCALE       111 // (*) (**) change this value if readed Battery voltage is different than real voltage
