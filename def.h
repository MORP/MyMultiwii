...
#if defined(i2cLidar) || defined(externLidar) || defined (genericLidar)
  #define LIDAR 1
#else
  #define LIDAR 0
#endif
...
#pragma region GENERIC LIDAR SUPPORT

#if defined(genericLidar)
#define LIDAR_GEP_TriggerPin             LIDAR_GENERIC_TRIGGER_PIN
#define LIDAR_GEP_TriggerPin_PINMODE_OUT pinMode(LIDAR_GEP_TriggerPin,OUTPUT);
#define LIDAR_GEP_TriggerPin_PIN_HIGH    PORTB |= 1<<6;
#define LIDAR_GEP_TriggerPin_PIN_LOW     PORTB &= ~(1<<6);
#define LIDAR_GEP_EchoPin                LIDAR_GENERIC_ECHO_PIN
#define LIDAR_GEP_EchoPin_PINMODE_IN     pinMode(LIDAR_GEP_EchoPin,INPUT);
#define LIDAR_GEP_EchoPin_PCINT          PCINT5
#define LIDAR_GEP_EchoPin_PCICR          PCICR |= (1<<PCIE0); // PCINT 0-7 belong to PCIE0
#define LIDAR_GEP_EchoPin_PCMSK          PCMSK0 = (1<<LIDAR_GEP_EchoPin_PCINT); // Mask Pin PCINT5 - all other PIns PCINT0-7 are not allowed to create interrupts!
#define LIDAR_GEP_EchoPin_PCINT_vect     PCINT0_vect  // PCINT0-7 belog PCINT0_vect
#define LIDAR_GEP_EchoPin_PIN            PINB  // PCINT0-7 belong to PINB
#endif
